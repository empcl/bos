 ...
 * Generated at: 2020-05-20 11:10:36 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/trainDetails.json',\r\n");
      out.write("                type: 'POST',\r\n");
      out.write("                dataType: 'text',\r\n");
      out.write("                success: function (data) {\r\n");
      out.write("                    var zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("                    $.fn.zTree.init($(\"#trainDetails\"), setting, zNodes);\r\n");
      out.write("                },\r\n");
      ...
      out.write("                url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/trainStatistics.json',\r\n");
      out.write("                type: 'POST',\r\n");
      out.write("                dataType: 'text',\r\n");
      out.write("                success: function (data) {\r\n");
      out.write("                    var zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("                    $.fn.zTree.init($(\"#trainStatistics\"), setting, zNodes);\r\n");
      out.write("                },\r\n");
      out.write("                error: function (msg) {\r\n");
      out.write("                    alert('菜单加载异常!');\r\n");
      out.write("                }\r\n");
      ...
      out.write("                url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/trainHistoryRecords.json',\r\n");
      out.write("                type: 'POST',\r\n");
      out.write("                dataType: 'text',\r\n");
      out.write("                success: function (data) {\r\n");
      out.write("                    var zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("                    $.fn.zTree.init($(\"#trainHistoryRecords\"), setting, zNodes);\r\n");
      out.write("                },\r\n");
      out.write("                error: function (msg) {\r\n");
      out.write("                    alert('菜单加载异常!');\r\n");
      out.write("                }\r\n");
      ...
      out.write("                url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/userTotalView.json',\r\n");
      out.write("                type: 'POST',\r\n");
      out.write("                dataType: 'text',\r\n");
      out.write("                success: function (data) {\r\n");
      out.write("                    var zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("                    $.fn.zTree.init($(\"#userTotalView\"), setting, zNodes);\r\n");
      out.write("                },\r\n");
      out.write("                error: function (msg) {\r\n");
      out.write("                    alert('菜单加载异常!');\r\n");
      out.write("                }\r\n");
      ...
      out.write("                url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/json/userTotalStatistics.json',\r\n");
      out.write("                type: 'POST',\r\n");
      out.write("                dataType: 'text',\r\n");
      out.write("                success: function (data) {\r\n");
      out.write("                    var zNodes = eval(\"(\" + data + \")\");\r\n");
      out.write("                    $.fn.zTree.init($(\"#userTotalStatistics\"), setting, zNodes);\r\n");
      out.write("                },\r\n");
      out.write("                error: function (msg) {\r\n");
      out.write("                    alert('菜单加载异常!');\r\n");
      out.write("                }\r\n");
      ...
      out.write("        [<strong>Tom</strong>]，欢迎你！\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("        ");
      out.write("\r\n");
      out.write("        <div title=\"训练数据详情\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">\r\n");
      out.write("            <ul id=\"trainDetails\" class=\"ztree\"></ul>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div title=\"训练数据分析\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">\r\n");
      out.write("            <ul id=\"trainStatistics\" class=\"ztree\"></ul>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div title=\"历史训练记录\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">\r\n");
      out.write("            <ul id=\"trainHistoryRecords\" class=\"ztree\"></ul>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div title=\"用户数据展示\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">\r\n");
      out.write("            <ul id=\"userTotalView\" class=\"ztree\"></ul>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div title=\"用户数据分析\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">\r\n");
      out.write("            <ul id=\"userTotalStatistics\" class=\"ztree\"></ul>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("                    学能教育 | Powered by <a href=\"http://www.empcl.cn/\">empcl.cn</a>\r\n");
      out.write("                </div>\r\n");
      out.write("            </td>\r\n");
