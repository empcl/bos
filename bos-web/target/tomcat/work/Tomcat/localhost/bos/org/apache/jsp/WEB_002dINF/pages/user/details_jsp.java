 ...
 * Generated at: 2020-05-20 11:09:05 UTC
...
public final class details_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<div style=\"align-content: left\">\r\n");
      out.write("    本次舒尔特5*5方格用时16秒，中间点错了2次。\r\n");
      out.write("</div>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("    // 基于准备好的dom，初始化echarts实例\r\n");
      out.write("    var myChart = echarts.init(document.getElementById('main'));\r\n");
      out.write("\r\n");
      out.write("    var names = [] // 用于记录当前描述情况\r\n");
      out.write("    var nums = [] // 用于记录当前注意力数值情况\r\n");
      out.write("\r\n");
      out.write("    $.ajax({\r\n");
      out.write("        type: \"post\",\r\n");
      out.write("        async: true,\r\n");
      out.write("        url: \"userAttentionAction_showDetails.action\",\r\n");
      out.write("        data: {},\r\n");
      out.write("        dataType: \"json\", // 返回数据是json格式\r\n");
      out.write("        success: function (result) {\r\n");
      out.write("            if (result) {\r\n");
      out.write("                for (var i = 0; i < result.length; i++)\r\n");
      out.write("                    names.push(result[i].name)\r\n");
      out.write("                for (var i = 0; i < result.length; i++)\r\n");
      out.write("                    nums.push(result[i].num)\r\n");
      out.write("            }\r\n");
      out.write("            myChart.setOption({\r\n");
      out.write("                title: {\r\n");
      out.write("                    text: '注意力变化折线图',\r\n");
